// C. Game Master
// Link - https://codeforces.com/problemset/problem/1608/C
...
void blackout_yash() {
	...
	vector <int> alpha(n), ans(n);
	fora(i, 0, n) store[i] = {arr[i].ss, i};
	sort(all(store));
	fora(i, 0, n) alpha[store[i].ss] = i;

// D. Deleting Divisors
// Link - https://codeforces.com/problemset/problem/1537/D
...
// Link - https://youtu.be/OBsIP46DZ28
void blackout_yash() {
	/*-------__👌Never Give Up👌__-------*/
	/*----__🤭🤭Stop Stalking🤭🤭__----*/
	...
	if (n & 1) cout << "Bob";
	else if (ceil(log2(n)) != floor(log2(n))) cout << "Alice";
	else {
		if ((unsigned)log2(n) & 1) cout << "Bob";
		else cout << "Alice";
	} cout << nline;
